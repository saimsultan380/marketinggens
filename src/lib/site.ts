...
export const navLinks = [
  {
    ...
    children: [
      ...
      { href: "/industries/restaurants", label: "Restaurants & Food" },
      { href: "/industries/ecommerce", label: "Ecommerce & Retail" },
      { href: "/industries/insurance", label: "Insurance Agencies" },
      { href: "/industries/medical", label: "Medical & Healthcare" },
      { href: "/industries/wellness", label: "Wellness Practices" },
      { href: "/industries/home-services", label: "Home Services & HVAC" },
      { href: "/industries/beauty-spas", label: "Salons & Spas" },
      { href: "/industries/fitness", label: "Fitness & Gyms" },
      { href: "/industries/real-estate", label: "Real Estate & Mortgage" },
      { href: "/industries/automotive", label: "Automotive Repair" },
      { href: "/industries/legal", label: "Legal & Professional" },
    ],
  },
  {
    href: "/services",
